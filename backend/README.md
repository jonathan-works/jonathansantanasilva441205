...
Justificativa: Eu escolhi uma API Getway MVC para centralizar as requisições dos clientes, consumo de serviços externos e por requisitos não funcionais predefinidos pelo desafio, mas por se tratar de requisitos funcionais de baixa complexidade, um Monolito resolveria o problema.
